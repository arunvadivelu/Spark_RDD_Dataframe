...
val txCidpqty = txTuplesPids.join(nPIds).map{case (pid,((cid,txqty),(pname, pprice,pqty))) => (cid,(txqty))}.take(10)
val txCidprice = txTuplesPids.join(nPIds).map{case (pid,((cid,txqty),(pname, pprice,pqty))) => (cid,(pprice))}.take(10)
